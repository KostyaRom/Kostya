...
sf::Vector2f toEuclidean(float radius, float angle, const sf::Vector2f &oculusRadius)
{
    return {
...
void update(sf::ConvexShape &oculus, const sf::Vector2f &mousePosition, sf::Vector2f &eyePosition)
{
    ...
    const sf::Vector2f oculusRadius = {15.f, 30.f};
    const sf::Vector2f offset = toEuclidean(15, angle, oculusRadius);
